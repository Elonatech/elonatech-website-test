...
const ComputerPages = lazy(() =>
  import("./pages/sales/computer/computerPages")
);
const OfficePages = lazy(() => import("./pages/sales/office/officePages"));
const PosPages = lazy(() => import("./pages/sales/pos/posPages"));
const PrintersPages = lazy(() =>
  import("./pages/sales/printers/printersPages")
);
const NetworkDevicesPages = lazy(() =>
  import("./pages/sales/networkDevices/networkDevicesPages")
);

// ========================= Dashboard Import ======================
const NavMenu = lazy(() => import("./components/dashboard-component/nav-menu"));
const SideMenu = lazy(() =>
  import("./components/dashboard-component/side-menu")
);
import DashboardContent from "./components/dashboard-component/dashboardContent";
const Blogs = lazy(() => {
  import("./components/dashboard-component/Blog");
});
